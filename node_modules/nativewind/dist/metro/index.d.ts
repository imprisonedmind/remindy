...
export declare function withNativeWind(config: MetroConfig, { input, inlineRem, configPath: tailwindConfigPath, browserslist, browserslistEnv, typescriptEnvPath, }?: WithNativeWindOptions): MetroConfig;
export {};
