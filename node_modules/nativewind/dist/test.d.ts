...
export declare function render(component: React.ReactElement<any>, { config, css, layers, logOutput, ...options }?: RenderOptions): Promise<{
...
export declare function enableCompilerLogging(enable: boolean): void;
