...
exports.enableCompilerLogging = enableCompilerLogging;
...
async function render(component, { config, css, layers = {}, logOutput, ...options } = {}) {
    css ??= Object.entries({
        base: true,
        components: true,
        utilities: true,
...
function enableCompilerLogging(enable) {
