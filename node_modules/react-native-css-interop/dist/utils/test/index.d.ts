...
export declare function render<T>(component: ReactElement<T>, { css, cssOptions, ...options }?: RenderOptions): {
    update: (component: ReactElement) => void;
    unmount: () => void;
...
export declare function registerCSS(css: string, options?: CssToReactNativeRuntimeOptions & {
    logOutput?: boolean;
}): void;
